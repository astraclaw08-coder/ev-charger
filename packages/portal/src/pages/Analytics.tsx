  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Trend filters + saved views</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <SummaryCard label="Sessions" value={summary.sessionsCount.toString()} icon="⚡" />
        <SummaryCard label="kWh Delivered" value={summary.kwhDelivered.toFixed(1)} icon="🔋" />
        <SummaryCard label="Revenue" value={`$${summary.revenueUsd.toFixed(2)}`} icon="💵" />
