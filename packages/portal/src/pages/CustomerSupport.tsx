  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Customer lookup + session timeline + case notes</p>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="lg:col-span-2 rounded-xl border border-gray-200 bg-white p-4">
          <h2 className="mb-3 text-sm font-semibold text-gray-700">Session timeline</h2>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4">
          ...
          <div className="mt-4 space-y-2">
            {notes.slice(0, 10).map((n) => (
              <div key={n.id} className="rounded-md border border-gray-200 p-2">
                <p className="text-xs text-gray-500">{new Date(n.createdAt).toLocaleString()} · session {n.sessionId}</p>
