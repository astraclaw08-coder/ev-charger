...
function ChargersIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={ICON_STROKE} className={className} aria-hidden="true">
      {/* Charger body */}
      <rect x="4" y="2" width="10" height="16" rx="2" strokeLinecap="round" strokeLinejoin="round" />
      {/* Screen / display */}
      <rect x="6.5" y="5" width="5" height="3.5" rx="0.75" strokeWidth="1.5" />
      {/* Plug port */}
      <circle cx="9" cy="13" r="1.5" />
      {/* Cable coming out right side */}
      <path strokeLinecap="round" strokeLinejoin="round" d="M14 8h2.5a1.5 1.5 0 0 1 1.5 1.5V16" />
      {/* Connector nozzle */}
      <path strokeLinecap="round" strokeLinejoin="round" d="M16 16h4M17 16v3M19 16v3" />
      {/* Base / stand */}
