...
export async function getChargerUptime(chargerId: string) {
  ...
  const d7ago = new Date(today.getTime() - 6 * 86400000); // today + 6 prior days = 7 days
  const d30ago = new Date(today.getTime() - 29 * 86400000); // today + 29 prior days = 30 days
